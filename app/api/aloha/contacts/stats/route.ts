/**
 * GET /api/aloha/contacts/stats
 * 
 * Returns contact statistics (same as contact-memory/summary)
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (contactsError) {
      console.error("[Contacts Stats] Error fetching contacts:", contactsError);
